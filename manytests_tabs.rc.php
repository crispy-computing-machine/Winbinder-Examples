...
_create_control($maintab, ListView, "", 4, 6, 325, 159, IDC_LISTVIEW2027, WBC_VISIBLE | WBC_ENABLED | WBC_SORT | WBC_LINES | WBC_CHECKBOXES | WBC_SINGLE, 0, 0);
_create_control($maintab, ComboBox, "", 340, 4, 184, 195, IDC_COMBOBOX2010, WBC_VISIBLE | WBC_ENABLED | WBC_READONLY, 0, 0);
_create_control($maintab, ListBox, "", 455, 29, 70, 136, IDC_LISTBOX2018, WBC_VISIBLE | WBC_ENABLED, 0, 0);
_create_control($maintab, EditBox, "", 4, 175, 265, 66, IDC_EDIT2064, WBC_VISIBLE | WBC_ENABLED | WBC_MULTILINE | WBC_READONLY, 0, 0);
_create_control($maintab, ListView, "", 280, 175, 245, 71, IDC_LISTVIEW2067, WBC_VISIBLE | WBC_ENABLED | WBC_SINGLE, 0, 0);
_create_control($maintab, EditBox, "0", 340, 45, 35, 21, IDC_LISTLINE, WBC_VISIBLE | WBC_ENABLED | WBC_NUMBER, 0, 0);
_create_control($maintab, Spinner, "", 378, 45, 16, 21, IDC_UPDOWN2069, WBC_VISIBLE | WBC_ENABLED, 0, 0);
...
_create_control($maintab, Frame, "Group box", 4, 6, 140, 89, IDC_GROUPBOX4012, WBC_VISIBLE | WBC_ENABLED, 0, 1);
_create_control($maintab, RadioButton, "Opt. A&1", 10, 24, 59, 14, IDC_RADIOBUTTON4014, WBC_VISIBLE | WBC_ENABLED | WBC_GROUP, 0, 1);
_create_control($maintab, RadioButton, "Opt. A&2", 10, 48, 59, 14, IDC_RADIOBUTTON4015, WBC_VISIBLE | WBC_ENABLED, 0, 1);
_create_control($maintab, RadioButton, "Opt. A&3", 10, 73, 59, 14, IDC_RADIOBUTTON4016, WBC_VISIBLE | WBC_ENABLED, 0, 1);
_create_control($maintab, RadioButton, "Opt. &B1", 74, 24, 58, 14, IDC_RADIOBUTTON4066, WBC_VISIBLE | WBC_ENABLED | WBC_GROUP, 0, 1);
_create_control($maintab, RadioButton, "&Opt. B2", 74, 48, 58, 14, IDC_RADIOBUTTON4067, WBC_VISIBLE | WBC_ENABLED, 0, 1);
_create_control($maintab, RadioButton, "O&pt. B3", 74, 73, 58, 14, IDC_RADIOBUTTON4068, WBC_VISIBLE | WBC_ENABLED, 0, 1);
_create_control($maintab, Gauge, "IDC_PROGRESSBAR4007", 184, 35, 103, 14, IDC_PROGRESSBAR4007, WBC_VISIBLE | WBC_ENABLED, 0, 1);
_create_control($maintab, Slider, "IDC_SLIDER4011", 148, 68, 145, 26, IDC_SLIDER4011, WBC_VISIBLE | WBC_ENABLED, 0, 1);
_create_control($maintab, Label, "0", 148, 35, 26, 14, IDC_STATIC4019, WBC_VISIBLE | WBC_ENABLED | WBC_RIGHT, 0, 1);
_create_control($maintab, ScrollBar, "IDC_HSCROLL4026", 154, 9, 136, 16, IDC_HSCROLL4026, WBC_VISIBLE | WBC_ENABLED, 0, 1);
_create_control($maintab, EditBox, "0", 148, 104, 40, 19, IDC_EDIT4030, WBC_VISIBLE | WBC_ENABLED | WBC_NUMBER, 0, 1);
_create_control($maintab, Spinner, "", 190, 104, 16, 19, IDC_UPDOWN4028, WBC_VISIBLE | WBC_ENABLED, 0, 1);
_create_control($maintab, CheckBox, "Checkbox 1", 14, 105, 91, 14, IDC_CHECKBOX4034, WBC_VISIBLE | WBC_ENABLED, 0, 1);
_create_control($maintab, Label, "(Values)", 4, 204, 316, 26, IDC_STATIC4048, WBC_VISIBLE | WBC_ENABLED | WBC_MULTILINE, 0, 1);
_create_control($maintab, CheckBox, "Checkbox 2", 14, 125, 91, 14, IDC_CHECKBOX4049, WBC_VISIBLE | WBC_ENABLED, 0, 1);
_create_control($maintab, ScrollBar, "", 298, 4, 16, 126, IDC_VSCROLL4051, WBC_VISIBLE | WBC_ENABLED, 0, 1);
_create_control($maintab, EditBox, "0", 235, 104, 40, 19, IDC_EDIT4052, WBC_VISIBLE | WBC_ENABLED | WBC_NUMBER, 0, 1);
_create_control($maintab, ListBox, "", 325, 4, 68, 52, IDC_LISTBOX4053, WBC_VISIBLE | WBC_ENABLED, 0, 1);
_create_control($maintab, ComboBox, "", 399, 4, 130, 195, IDC_COMBOBOX4054, WBC_VISIBLE | WBC_ENABLED | WBC_READONLY, 0, 1);
_create_control($maintab, ListBox, "", 399, 29, 130, 21, IDC_LISTBOX4055, WBC_VISIBLE | WBC_ENABLED, 0, 1);
_create_control($maintab, ScrollBar, "IDC_HSCROLL4056", 148, 130, 145, 16, IDC_HSCROLL4056, WBC_VISIBLE | WBC_ENABLED, 0, 1);
_create_control($maintab, EditBox, "Pack my box with five dozen liquor jugs", 4, 152, 155, 21, IDC_EDIT4057, WBC_VISIBLE | WBC_ENABLED, 0, 1);
_create_control($maintab, EditBox, "", 4, 175, 155, 21, IDC_EDIT4058, WBC_VISIBLE | WBC_ENABLED | WBC_READONLY, 0, 1);
_create_control($maintab, EditBox, "", 169, 152, 145, 21, IDC_EDIT4059, WBC_VISIBLE | WBC_ENABLED | WBC_MASKED, 0, 1);
_create_control($maintab, Label, "&Digits only:", 169, 180, 55, 21, IDC_STATIC4063, WBC_VISIBLE | WBC_ENABLED | WBC_RIGHT, 0, 1);
_create_control($maintab, EditBox, "", 226, 175, 89, 21, IDC_EDIT4060, WBC_VISIBLE | WBC_ENABLED | WBC_NUMBER, 0, 1);
_create_control($maintab, EditBox, "", 325, 61, 205, 55, IDC_EDIT4065, WBC_VISIBLE | WBC_DISABLED | WBC_MULTILINE, 0, 1);
_create_control($maintab, Label, "Drag me:", 193, 52, 59, 14, IDC_STATIC4064, WBC_VISIBLE | WBC_ENABLED | WBC_CENTER, 0, 1);
_create_control($maintab, EditBox, "", 325, 125, 205, 21, IDC_EDIT4069, WBC_VISIBLE | WBC_ENABLED, 0, 1);
_create_control($maintab, EditBox, "", 340, 154, 190, 81, IDC_EDIT4071, WBC_VISIBLE | WBC_ENABLED | WBC_MULTILINE, 0, 1);
...
_create_control($maintab, Frame, "", 125, 8, 119, 68, IDC_SHAPE5058, WBC_VISIBLE | WBC_ENABLED, 0, 2);
_create_control($maintab, Frame, "Group box", 4, 4, 110, 71, IDC_GROUPBOX5012, WBC_VISIBLE | WBC_ENABLED, 0, 2);
...
_create_control($maintab, PushButton, "Run &Tests", 10, 14, 80, 30, ID_LOWLEVEL, WBC_VISIBLE | WBC_ENABLED, 0, 3);
_create_control($maintab, EditBox, "", 194, 9, 275, 216, IDC_EDIT6002, WBC_VISIBLE | WBC_ENABLED | WBC_MULTILINE | WBC_READONLY, 0, 3);
_create_control($maintab, PushButton, "Reset &Handler", 10, 50, 80, 30, ID_RESETHANDLER, WBC_VISIBLE | WBC_ENABLED, 0, 3);
