...
define("WBOBJ32",			"Vhwnd/Vid/Vuclass/litem/lsubitem/Vstyle/Vparent/Vhandler/Vlparam/V8lparams/Vpbuffer");

// @todo Update example
#define("WBOBJ64",			"Phwnd/Jid/JuClass/qitem/qsubitem/Istyle/PParent/pcallbackFn/PcallbackObj/Plparam/8Plparams/4IrcTitle/2IarMin/2IarMax/Phbuffer");
...
function test_lowlevel($window)
{
	...
	$result .= "Peek/poke window callback\n\n";
		...
		$wbobj = unpack(WBOBJ, wb_peek($window));
