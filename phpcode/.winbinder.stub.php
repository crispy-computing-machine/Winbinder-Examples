<?php
const AppWindow = 1; // A fixed-size application window.
const ModalDialog = 2; // A modal dialog box (requires to be closed before continuing to other tasks).
const ModelessDialog = 3; // A modeless dialog box (other tasks can be performed while it is open).
const NakedWindow = 4; // A fixed-size application window with no border and no title bar.
const PopupWindow = 5; // A fixed-size application window that cannot be minimized.
const ResizableWindow = 6; // A normal application window with a resizable border.
const ToolDialog = 7; // A modeless dialog box with a small caption.
const Accel = 8;
const Calendar = 9;
const CheckBox = 10;
const ComboBox = 11;
...
const ToolBar = 31;
const TreeView = 32;
const Timer = Timer; // Doesnt really exist - Added for IDE help
//define('PopupMenu', PopupMenu); // Doesnt really exist - Added for IDE help
const WBC_VERSION = '2010.10.14';
const WBC_BORDER = 8;
 ...
 * Parameter command may be used to play a WAV sound synchronously or in a loop.
...
/**
 * Destroys a control created by _create_control().
 *
 * Returns TRUE on success or FALSE if an error occurs.
 *
 * Tip
 ...
 * The class is passed as a parameter to functions _create_control() and wb_create_window().
 *
 * @param $wbobject
 *
 * @return int
 ...
 * @return int
 */
function wb_set_accel_table($parent, $accels)
{
}
 ...
 * @return int
 */
function _create_control($parent, $class, $caption, $xpos, $ypos, $width, $height, $id, $style, $lparam, $ntab)
{
}
 ...
 * @return int
 */
function wb_create_item($ctrl, $str)
{
}
 ...
 * @return int
 */
function wb_create_statusbar_items($ctrl, $items, $clear, $param)
{
}
 ...
 * @return int
 */
function _get_text($ctrl, $item = null)
{
}
 ...
 * @return int
 */
function _set_text($ctrl, $text, $item)
{
}
 ...
 * @return int
 */
function wb_select_tab($ctrl, $selitems)
{
}
 ...
 * @return int
 */
function wb_create_listview_item($ctrl, $item, $image, $value)
{
}
 ...
 * @return int
 */
function wb_set_listview_item_checked($ctrl, $index, $value)
{
}
 ...
 * @return bool
 */
function wb_get_listview_item_checked($ctrl, $item)
{
}
 ...
 * @return int
 */
function wb_set_listview_item_text($ctrl, $item, $subitem, $text)
{
}
 ...
 * @return mixed
 */
function wb_get_listview_text($ctrl, $item)
{
}
 ...
 * @return int
 */
function wb_get_listview_columns($ctrl)
{
}
 ...
 * @return int
 */
function wb_create_listview_column($ctrl, $i, $text, $width, $align)
{
}
 ...
 * @return int
 */
function wb_clear_listview_columns($ctrl)
{
}
 ...
 * @return int
 */
function wb_select_listview_item($ctrl, $item, $selected)
{
}
 ...
 * @return int
 */
function wb_select_all_listview_items($ctrl, $bool)
{
}
 ...
 * @return int
 */
function wb_create_menu($parent, $caption)
{
}
 ...
 * @return int
 */
function wb_get_menu_item_checked($ctrl, $item)
{
}
 ...
 * @return int
 */
function wb_set_menu_item_checked($ctrl, $selitems, $selected)
{
}
 ...
 * @return int
 */
function wb_set_menu_item_selected($ctrl, $item, $selected)
{
}
 ...
 * @return int
 */
function wb_set_menu_item_image($ctrl, $item, $imageHandle)
{
}
 ...
 * @return int
 */
function wb_create_toolbar($parent, $caption, $width, $height, $lparam)
{
}
 ...
 * @return int
 */
function wb_create_treeview_item($ctrl, $name, $value, $where = 0, $image_index = 0, $selected_image = 0, $selected_image_index = 0)
{
}
 ...
 * @return int
 */
function wb_set_treeview_item_selected($ctrl, $selitems)
{
}
 ...
 * @return bool
 */
function wb_set_treeview_item_text($ctrl, $item, $text)
{
}
 ...
 * @return int
 */
function wb_set_treeview_item_value($ctrl, $item, $value)
{
}
 ...
 * @return int
 */
function wb_get_treeview_item_text($ctrl, $item)
{
}
 ...
 * @return int
 */
function _sys_dlg_open($parent, $title = null, $filter = null, $path = null, $flags = null)
{
}
 ...
 * @return int
 */
function _sys_dlg_save($wbObj, $title = '', $filter = '', $path = '', $filename = '', $defext = '')
{
}

/**
 * Get clipboard data
 * @see: https://learn.microsoft.com/en-us/windows/win32/api/winuser/nf-winuser-getclipboarddata
 * uFormat = (CF_TEXT)
 * @return string|null
 */
function wb_get_clipboard()
{
}

/**
 * Set clipboard data (text)
 * $clip - Text string to set as clipboard data
 * @param string $clip
 * @return bool
 */
function wb_set_clipboard($clip)
{
}

/**
 * Empty clipboard text data
 * @return bool
 */
function wb_empty_clipboard()
{
}

/**
 * Get mouse cursor position as array x, y
 ...
 * @return array
 */
function wb_get_mouse_pos($pwbo = null)
{
}